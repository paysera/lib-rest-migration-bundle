...
namespace Paysera\Bundle\RestMigrationBundle\DependencyInjection\Compiler;
...
class ApiCompilerPass implements CompilerPassInterface
{
     ...
     * @param bool $ignoreOnNoAttribute
     *
    ...
    protected function processTags($container, $tag, $attributeName, $methodName, $ignoreOnNoAttribute = false)
    {
        ...
        foreach ($container->findTaggedServiceIds($tag) as $id => $tags) {
            ...
            if (!isset($attributes[$attributeName])) {
                ...
                $definition->addMethodCall($methodName, [new Reference($id), $attributes[$attributeName]]);
            }
        }
    }
}
